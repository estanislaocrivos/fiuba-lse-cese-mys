...
proc create_root_design { parentCell } {
  ...
  # Create instance: rst_uC_0_100M, and set properties
  set rst_uC_0_100M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_uC_0_100M ]

  # Create instance: uC_0, and set properties
  set uC_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:processing_system7:5.5 uC_0 ]
  ...
  # Create instance: uC_0_axi_periph, and set properties
  set uC_0_axi_periph [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 uC_0_axi_periph ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
 ] $uC_0_axi_periph
  ...
  connect_bd_intf_net -intf_net Microcontroller_0_M_AXI_GP0 [get_bd_intf_pins uC_0/M_AXI_GP0] [get_bd_intf_pins uC_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net Microcontroller_0_axi_periph_M00_AXI [get_bd_intf_pins FIR_Filter_0/S_AXI] [get_bd_intf_pins uC_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins uC_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins uC_0/FIXED_IO]

  # Create port connections
  connect_bd_net -net FIR_Filter_0_filter_output [get_bd_pins FIR_Filter_0/filter_output] [get_bd_pins vio_0/probe_in0]
  connect_bd_net -net Microcontroller_0_FCLK_RESET0_N [get_bd_pins rst_uC_0_100M/ext_reset_in] [get_bd_pins uC_0/FCLK_RESET0_N]
  connect_bd_net -net rst_Microcontroller_0_100M_interconnect_aresetn [get_bd_pins rst_uC_0_100M/interconnect_aresetn] [get_bd_pins uC_0_axi_periph/ARESETN]
  connect_bd_net -net rst_Microcontroller_0_100M_peripheral_aresetn [get_bd_pins FIR_Filter_0/s_axi_aresetn] [get_bd_pins rst_uC_0_100M/peripheral_aresetn] [get_bd_pins uC_0_axi_periph/M00_ARESETN] [get_bd_pins uC_0_axi_periph/S00_ARESETN]
  connect_bd_net -net uC_0_FCLK_CLK0 [get_bd_pins FIR_Filter_0/s_axi_aclk] [get_bd_pins rst_uC_0_100M/slowest_sync_clk] [get_bd_pins uC_0/FCLK_CLK0] [get_bd_pins uC_0/M_AXI_GP0_ACLK] [get_bd_pins uC_0_axi_periph/ACLK] [get_bd_pins uC_0_axi_periph/M00_ACLK] [get_bd_pins uC_0_axi_periph/S00_ACLK] [get_bd_pins vio_0/clk]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces uC_0/Data] [get_bd_addr_segs FIR_Filter_0/S_AXI/S_AXI_reg] SEG_FIR_Filter_0_S_AXI_reg
